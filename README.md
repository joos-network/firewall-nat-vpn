...
- В Linux системах реализован в виде модуля ядра, что дополнительно величивает производительность
- Протокол может работать на любом из портов UDP, уществуют клиенты од все основные латформы: Windows, ac OS, Linux, Apple OS, Android
